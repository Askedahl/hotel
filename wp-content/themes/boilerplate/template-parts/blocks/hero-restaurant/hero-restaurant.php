...
$button = get_field('hero-restaurant_button');
$header = get_field('hero_header');
$title = get_field('hero-restaurant_title');
$link = get_field('hero-restaurant_link');
?>
...
<div class="hero">
    ...
    <div class="hero__background__video">
        <video loop muted autoplay preload="auto">
            <source src="<?= get_template_directory_uri() . '/assets/video/Morgenmad.mp4' ?>" type="video/mp4">
    ...
    <div class="secundary-menu__container2">
                        <?php
                        wp_nav_menu( array(
                            'theme_location' => 'Restaurant-bar menu',
                            'menu_class'     => 'nav',
                            'container'      => 'nav'
                        ) );
                        ?>
