...
$button = get_field('hero-contact_button');
$header = get_field('hero_header');
$title = get_field('hero-contact_title');
$img = get_field('hero-contact_img');
$link = get_field('hero-contact_link');
?>
...
<div class="hero">
    ...
    <div class="secundary-menu__container2">
                        <?php
                        wp_nav_menu( array(
                            'theme_location' => 'Kontakt-ankomst menu',
                            'menu_class'     => 'nav',
                            'container'      => 'nav'
                        ) );
                        ?>
