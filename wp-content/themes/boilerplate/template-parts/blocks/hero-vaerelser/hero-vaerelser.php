...
$button = get_field('hero-vaerelser_button');
$header = get_field('hero_header');
$title = get_field('hero-vaerelser_title');
$link = get_field('hero-vaerelser_link');
?>
...
<div class="hero">
    ...
    <div class="hero__background__video">
        <video loop muted autoplay preload="auto">
            <source src="<?= get_template_directory_uri() . '/assets/video/Værelser.mp4' ?>" type="video/mp4">
